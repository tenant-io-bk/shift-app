    ...
    <div style={{ maxWidth: 390, minHeight: '100vh', margin: '0 auto', background: 'var(--paper)' }}>
      ...
      <div style={{ padding: '16px 16px 0' }}>
        <div style={{
          ...
          <div style={{ position: 'absolute', top: 0, right: -20, width: 120, height: '100%', background: 'rgba(255,255,255,0.04)', transform: 'skewX(-12deg)' }} />
          <div style={{ position: 'absolute', top: 0, right: 40, width: 60, height: '100%', background: 'rgba(255,255,255,0.03)', transform: 'skewX(-12deg)' }} />
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 8 }}>
            ...
            <span style={{ fontFamily: 'var(--body)', fontSize: 9, fontWeight: 600, color: 'rgba(255,255,255,0.5)', letterSpacing: '0.1em', textTransform: 'uppercase', marginTop: 1 }}>SHIFT Wallet</span>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
            <div>
              <div style={{ fontFamily: 'var(--body)', fontSize: 9, fontWeight: 700, color: 'rgba(255,255,255,0.5)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: 3 }}>Linked account</div>
