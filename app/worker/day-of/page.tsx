      ...
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 120 }}>
        ...
        >
          ...
          >
            ...
            {/* DeKalb stop (start) */}
            <circle cx="80" cy="100" r="5" fill="white" stroke="#5A3CC2" strokeWidth="2" />
            <circle cx="80" cy="100" r="2.5" fill="#5A3CC2" />

            {/* Bedford-Nostrand stop (end/destination) */}
            <circle cx="240" cy="22" r="6" fill="white" stroke="#5A3CC2" strokeWidth="2" />
            <circle cx="240" cy="22" r="3" fill="#5A3CC2" />

            {/* Station labels */}
            <text x="90" y="104" fontFamily="monospace" fontSize="9" fill="#6B6E78">DeKalb Av</text>
            <text x="250" y="26" fontFamily="monospace" fontSize="9" fill="#5A3CC2">Bedford-Nostrand</text>

            {/* You are here dot */}
            <circle cx="80" cy="125" r="5" fill="#5A3CC2" opacity="0.9" />
