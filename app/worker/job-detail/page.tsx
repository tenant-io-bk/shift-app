...
function SlideToConfirm({ label = 'Slide to confirm', href }: { label?: string; href: string }) {
  ...
  return (
    <div ref={trackRef} style={{
      ...
      background: 'var(--ink)', borderRadius: 99, overflow: 'hidden',
      ...
      <div style={{
        ...
        fontFamily: 'var(--sans)', fontWeight: 600, fontSize: 16, color: '#fff',
        ...
        {label} <span style={{ marginLeft: 10, opacity: 0.6 }}>→</span>
      </div>
      {/* Done label */}
      <div style={{
        position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <SlideToConfirm label="Slide to take shift" href="/worker/confirm" />
