        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path
                d="M2 2h10c.55 0 1 .45 1 1v6c0 .55-.45 1-1 1H4l-3 3V3c0-.55.45-1 1-1Z"
          ...
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path
                d="M2.5 2C2.5 2 1 2 1 4c0 5 3.5 9 9 9 2 0 2-1.5 2-1.5v-2s0-1-1.5-1c-.5 0-1 .5-1 .5C8.5 9.5 6 7 5.5 6l.5-1c0 0 .5-.5.5-1 0-1.5-1-1.5-1-1.5H3Z"
                stroke="rgba(255,255,255,0.70)"
                strokeWidth="1.3"
                strokeLinejoin="round"
              />
