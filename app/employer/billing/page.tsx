  ...
  return (
    <div style={{ maxWidth: 390, minHeight: '100vh', margin: '0 auto', background: 'var(--paper)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ padding: '20px 22px 140px', flex: 1, overflowY: 'auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div>
              ...
              <input type="text" inputMode="numeric" value={cardNum} onChange={e => setCardNum(formatCard(e.target.value))}
                ...
                style={{ width: '100%', height: 52, padding: '0 16px', background: 'var(--card)', border: '2px solid var(--ink)', borderRadius: 14, fontFamily: 'var(--mono)', fontSize: 16, letterSpacing: '0.1em', color: 'var(--ink)', outline: 'none' }} />
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div>
                ...
                <input type="text" inputMode="numeric" value={expiry} onChange={e => setExpiry(formatExpiry(e.target.value))}
                  placeholder="MM / YY"
                  style={{ width: '100%', height: 52, padding: '0 16px', background: 'var(--card)', border: '2px solid var(--ink)', borderRadius: 14, fontFamily: 'var(--mono)', fontSize: 16, letterSpacing: '0.08em', color: 'var(--ink)', outline: 'none' }} />
              </div>
              <div>
                ...
                <input type="password" value={cvv} onChange={e => setCvv(e.target.value.replace(/\D/g, '').slice(0, 4))}
                  placeholder="•••"
                  style={{ width: '100%', height: 52, padding: '0 16px', background: 'var(--card)', border: '2px solid var(--ink)', borderRadius: 14, fontFamily: 'var(--mono)', fontSize: 20, color: 'var(--ink)', outline: 'none' }} />
              </div>
            </div>
        ...
        {/* Trust */}
        <div style={{ marginTop: 20, padding: '12px 16px', background: 'var(--paper-2)', borderRadius: 14, border: '2px solid var(--ink)' }}>
