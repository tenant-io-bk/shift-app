  ...
  return (
    <div style={{ maxWidth: 390, minHeight: '100vh', margin: '0 auto', background: 'var(--paper)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ height: 44, padding: '0 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid var(--line)' }}>
        ...
        <span style={{ fontFamily: 'var(--mono)', fontSize: 11, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--mute)' }}>Business profile</span>
        <div style={{ width: 20 }} />
      </div>
      ...
      <div style={{ padding: '20px 22px 140px', flex: 1, overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 28, padding: '16px', background: 'var(--card)', borderRadius: 12, border: '1px solid var(--line)' }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontFamily: 'var(--mono)', fontSize: 12, color: 'var(--mute)', marginBottom: 8 }}>Square image works best</div>
